...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['pt'][] = 'Studio Pro - desenho com relatório';
        ...
        $this->messages['pt'][] = 'Página com vídeo Embutido';
        ...
        $this->messages['pt'][] = 'Visão de ícone';
        $this->messages['pt'][] = 'Linha do tempo';
        $this->messages['pt'][] = 'Formulário Bootstrap com abas internas';
        ...
        $this->messages['pt'][] = 'Calendário com cortina';
        $this->messages['pt'][] = 'Lançamentos de caixa';
        $this->messages['pt'][] = 'Agregações de coleções';
        $this->messages['pt'][] = 'Cards para produtos';
        $this->messages['pt'][] = 'Formulário HTML manual';
        $this->messages['pt'][] = 'Datagrid nativa';
        $this->messages['pt'][] = 'Gráfico de colunas';
        $this->messages['pt'][] = 'Lista de checagem';
        $this->messages['pt'][] = 'Exportação de datagrid';
        $this->messages['pt'][] = 'Ver detalhes';
        $this->messages['pt'][] = 'Relatório com query manual';
        ...
        $this->messages['pt'][] = 'Relatório tabular sobre view';
        $this->messages['pt'][] = 'Janela modal';
        $this->messages['pt'][] = 'Exportar';
        $this->messages['pt'][] = 'Plugin círculo';
        $this->messages['pt'][] = 'Carrossel';
        $this->messages['pt'][] = 'Passos';
        $this->messages['pt'][] = 'Log de transação com dump';
