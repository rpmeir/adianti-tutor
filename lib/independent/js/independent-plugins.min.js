...
(bgColor?' style="background-color:'+bgColor+'"':"")+"></span>"+"</td>"+'<td class="fc-list-item-title '+view.widgetContentClass+'">'+"<a"+(url?' href="'+htmlEscape(url)+'"':"")+">"+seg.event.title+"</a>"+"</td>"+"</tr>"}});fcViews.list={"class":ListView,buttonTextKey:"list",defaults:{buttonText:"list",listDayFormat:"LL",noEventsMessage:"No events to display"}};fcViews.listDay={type:"list",duration:{days:1},defaults:{listDayFormat:"dddd"}};fcViews.listWeek={type:"list",duration:{weeks:1},
